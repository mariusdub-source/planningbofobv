...
- filtres par budget, escales, classe, durée, bagages et tri ;
...
> Cette version est prête pour un premier déploiement technique avec filtres côté interface et côté API de démonstration. Les prix de vols réels nécessitent encore l'intégration d'un fournisseur de données vols.
